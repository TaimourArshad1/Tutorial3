...
int main(void)
{
    struct players Player1; /* Declare Player1  of type player */
    struct players Player2; /* Declare Player2  of type player */
    struct players Player3; /* Declare Player3  of type player */
    struct players Player4; /* Declare Player4  of type player */
